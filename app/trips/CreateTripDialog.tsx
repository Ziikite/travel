...
export function CreateTripDialog() {
  ...
  return (
    <>
      ...
      <dialog
        ref={dialogRef}
        className="w-full max-w-sm rounded-2xl border border-border p-6 backdrop:bg-black/40 dark:border-zinc-800 dark:bg-zinc-900"
      >
        <form action={createTrip} className="flex flex-col gap-2">
          <h2 className="text-section-title text-ink dark:text-zinc-50">
            새 여행방 만들기
          </h2>
          <input
            name="title"
